...
namespace libmedusa {
	...
	class Machine {
		public:
			 ...
			 *
			 *  @return	std::vector<mem_reg_t> An `std::vector` of all of the
			 * memory regions.
			 */
			 ...
			 *
			 *  @return	mem_reg_t An object describing the region this address
			 * belongs to.
			 */
			...
			/**
			 *  @brief Execute code in memory of a specified size at a specified
			 * address.
			 *
			...
			/**
			 *  @brief Execute code in memory of a specifed number of
			 * instructions at a specified address.
			 *
			 *  @param addr	The address to execute code from/at.
			...
			/**
			 *  @brief Execute a number of instructions at the current
			 * PC/IP/whatever it's called for this particular machine.
			 *
			 *  @param num The number of instructions to execute.
			 *
			 *  @return	true  success
			 ...
			 *
			 *  @return	std::vector<insn_t> The disassembled machine-code in the
			 * form of an `std::vector` of insn_t's.
			 */
			virtual std::vector<insn_t> disassemble(std::vector<uint8_t>& data,
													flag_t flags) = 0;

			/**
			 *  @brief Assemble an `std::string` with assembly code into
			 * machine-code.
			 *
			 *  @param src	 The source code to assemble.
			 *  @param addr	 The address at which this code would be located.
			 *  @param flags Machine-specific flags that can modify the
			 * machine-code.
			 *
			 *  @return	std::vector<uint8_t> The assembled machine-code in the
			 * form of an `std::vector` of `uint8_t`'s.
			 */
