...
namespace libmedusa {
	/**
	 *	@brief An example Component to demonstrate a Component interface.
	 */
	class ExampleComponent : public Component {
		public:
			...
			/**
			 *	@brief Get a random integer from this Component.
			 *
			 *	@returns A random integer generated by this Component.
			 */
