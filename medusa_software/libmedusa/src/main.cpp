...
uint8_t test_arm_code[] = {
	0x00, 0x00, 0xA0, 0xE1, 0x41, 0x00, 0xB0, 0xE3, 0x20, 0x04,
	0x00, 0xE3, 0x69, 0x10, 0x00, 0xE3, 0x01, 0x00, 0x40, 0xE0,
	0x00, 0x10, 0x81, 0xE0, 0x00, 0x00, 0xA0, 0xE1,
};
...
int main(int argc, char *argv[]) {
	...
	vector<uint8_t> data;
	vector<uint8_t> test_arm_thumb_code_vector(test_arm_thumb_code,
	...
	vector<uint8_t> test_arm64_code_vector(test_arm64_code,
	...
	vector<uint8_t> code_vector2(test_arm64_code, test_arm64_code + sizeof(test_arm64_code));
